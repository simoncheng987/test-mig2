 ...
 *         incorrect scene while in practice mode.
 */
public class Incorrect_Scene_Practice_Controller {
	 ...
	 * @param window
	 */
	public Incorrect_Scene_Practice_Controller(GUI_Manager gui_manager,
			Stage window) {
	...
	public void set_back_button() {
		Button back_button = gui_manager.get_incorrect_scene_practice()
				.get_back_button();
