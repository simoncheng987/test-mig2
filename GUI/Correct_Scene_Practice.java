...
public class Correct_Scene_Practice extends Scene {
	...
	private static Correct_Scene_Practice correct_scene_instance = null;
	...
	public Correct_Scene_Practice(Parent root, double width, double height) {
		super(root, width, height);
	}

	public Correct_Scene_Practice(Parent root) {
		super(root);
	}
